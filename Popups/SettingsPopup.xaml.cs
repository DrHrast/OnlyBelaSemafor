...
public partial class SettingsPopup : Popup
{
    ...
    private void SetTeamsButton_Clicked(object sender, EventArgs e)
    {
        ...
        var label1 = new Label { Text = "Prvi Tim:", Margin = new Thickness(10) };
        //var entry1 = new Entry { Placeholder = "Ime prvog tima:", Margin = new Thickness(10) };
        var label2 = new Label { Text = "Drugi tim:", Margin = new Thickness(10) };
        //var entry2 = new Entry { Placeholder = "Ime drugog tima", Margin = new Thickness(10) };
